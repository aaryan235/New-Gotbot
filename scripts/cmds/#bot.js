...
config: {
 ...
 onStart: async function ({  }) { },
  ...
  if ((event.body.toLowerCase() == "aaryan") || (event.body.toLowerCase() == "aryan") || (event.body.toLowerCase() == "Aaryan")) {
